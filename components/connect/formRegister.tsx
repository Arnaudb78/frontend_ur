...
const FormRegister: React.FC<FormConnectProps> = ({ setShowSignup }) => {
    ...
    return(
        <>
        <form onSubmit={handleSubmit} className="bg-[url('/images/bg-flower.jpg')] bg-cover p-8 rounded-2xl bg-opacity-15 text-secondary-200 text-sm flex flex-col gap-4 ">
